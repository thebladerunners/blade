...
static const int64 MAX_MINT_PROOF_OF_STAKE = 20.19 * CENT; // 20.19% interest per year
...
public:
    ...
    {
        // Protocol switch to support p2pool at Blade block #9689
        ...
        // Before Blade block #9689 - old protocol
